<template>
  <article class="text-gray-400 relative p-5 pb-7 rounded-xl bg-white text-sm text-gray-400 flex flex-col gap-2">
    <p class="text-xs border-b border-solid fill-gray-400 border-slate-200 flex items-center gap-1 pb-2">
    ...
    <header class="flex gap-1 items-center">
      ...
      <small class="text-xs">@charfeddine</small>
    </header>

    <p>Hello, someone can help me to finish my courses please ?</p>
  </article>
</template>