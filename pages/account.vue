...
<template>
  <main class="font-poppins text-default h-screen bg-custom-light-gray dark:bg-default flex flex-col align-top mx-auto">
    ...
    <section class="flex flex-col justify-between items-start gap-5 flex-1 p-5 h-0">
      <div>
      ...
      <div class="text-sm font-medium w-full flex-1 h-0 flex items-start justify-start flex-col">
        ...
        <div class="overflow-auto snap-y flex-1 w-full rounded-2xl shadow-sm">
            <div class="snap-start flex text-light-gray fill-light-gray items-center justify-between bg-white px-4 py-3.5 rounded-t-2xl border-b border-solid border-custom-light-gray">
                <div class="flex items-center justify-start gap-3">
            ...
            <div class="snap-start flex text-light-gray fill-light-gray items-center justify-between bg-white px-4 py-3.5 border-b border-solid border-custom-light-gray">
                <div class="flex items-center justify-start gap-3">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div @click.prevent="handleLogout" class="snap-start flex text-light-gray stroke-light-gray fill-light-gray items-center justify-between bg-white px-4 py-3.5 rounded-b-2xl">
                <div class="flex items-center justify-start gap-3">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
