...
<template>
    <section class="flex flex-col justify-between items-start gap-3 flex-1 px-5 h-0">
      ...
      <div class="grid grid-cols-3 divide-x divide-custom-purple items-center w-full bg-white rounded-2xl py-2.5 shadow-sm">
          <h2 class="font-semibold text-xs text-center break-words">56<br />followers</h2>
          <h2 class="font-semibold text-xs text-center break-words">536<br />following</h2>
          <h2 class="font-semibold text-xs text-center break-words">21<br />threads</h2>
      </div>

        <ui-mini-ad class="!mb-0" />

        <div class="text-sm font-medium w-full flex-1 h-0 flex items-start justify-start flex-col">
          <div class="overflow-auto snap-y flex-1 w-full flex flex-col gap-3 rounded-2xl mb-3">
            <div class="snap-start flex text-light-gray fill-light-gray items-center justify-between bg-white px-4 py-3.5 rounded-2xl border-b border-solid border-custom-light-gray">
            ...
            <div @click.prevent="handleLogout" class="snap-start flex text-light-gray stroke-light-gray fill-light-gray items-center justify-between bg-white px-4 py-3.5 rounded-2xl">
                <div class="flex items-center justify-start gap-3 text-default stroke-default">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
