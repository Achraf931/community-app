...
<template>
    ...
    <section id="content" class="flex flex-col flex-1 overflow-hidden gap-3 p-5 pb-0">
        ...
        <div class="overflow-scroll flex-1 snap-y flex flex-col gap-3">
            ...
            <article class="snap-start flex items-center justify-start gap-4 rounded-3xl bg-white shadow-sm mb-3">
                ...
                <div class="flex gap-2 items-center w-full py-4">
                    <div class="w-full">
                        ...
                        <p class="text-xs text-light-gray">Téléchargez Revolut et profitez mieux de votre argent chaque jour</p>
                    </div>
                </div>
