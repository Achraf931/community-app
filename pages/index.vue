...
<template>
    <div id="header" class="p-5">
        ...
        <div class="relative">
            ...
            <div class="absolute top-full left-0 pt-5 max-h-[390px] w-full">
        ...
        <div class="w-full flex items-center justify-between gap-4">
            ...
            <article>
                ...
                <p class="text-xs text-center mt-2 text-light-gray">Groupes</p>
            </article>
            <article>
                <div class="flex items-center justify-center w-16 h-16 shadow-sm rounded-full object-cover bg-white">
                    <svg class="fill-light-gray" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M13.403 24h-13.403v-22h3c1.231 0 2.181-1.084 3-2h8c.821.916 1.772 2 3 2h3v9.15c-.485-.098-.987-.15-1.5-.15l-.5.016v-7.016h-4l-2 2h-3.897l-2.103-2h-4v18h9.866c.397.751.919 1.427 1.537 2zm5.097-11c3.035 0 5.5 2.464 5.5 5.5s-2.465 5.5-5.5 5.5c-3.036 0-5.5-2.464-5.5-5.5s2.464-5.5 5.5-5.5zm0 2c1.931 0 3.5 1.568 3.5 3.5s-1.569 3.5-3.5 3.5c-1.932 0-3.5-1.568-3.5-3.5s1.568-3.5 3.5-3.5zm2.5 4h-3v-3h1v2h2v1zm-15.151-4.052l-1.049-.984-.8.823 1.864 1.776 3.136-3.192-.815-.808-2.336 2.385zm6.151 1.052h-2v-1h2v1zm2-2h-4v-1h4v1zm-8.151-4.025l-1.049-.983-.8.823 1.864 1.776 3.136-3.192-.815-.808-2.336 2.384zm8.151 1.025h-4v-1h4v1zm0-2h-4v-1h4v1zm-5-6c0 .552.449 1 1 1 .553 0 1-.448 1-1s-.447-1-1-1c-.551 0-1 .448-1 1z"/></svg>
                </div>
                <p class="text-xs text-center mt-2 text-light-gray">Jobs</p>
            </article>
        </div>
    </div>
        ...
        <div class="overflow-scroll flex-1 snap-y flex flex-col gap-3">
            <article class="snap-start flex align-baseline justify-start gap-4 rounded-3xl bg-white shadow-sm p-4">
                <div class="flex flex-col justify-between">
                    ...
                    <div>
                        <small class="flex items-center justify-center text-light-gray fill-light-gray gap-1.5 font-medium">
                            201
            ...
            <article class="snap-start flex items-center justify-start gap-4 rounded-3xl bg-white shadow-sm">
                <img class="w-8 h-8 ml-4" src="/images/revolut.png" alt="Logo Revolut">
                <div class="flex gap-2 items-center w-full py-4">
                    <div class="w-full">
                        <div class="flex items-center justify-start gap-2">
                            <p class="text-[9px] py-0.5 px-1 rounded-md bg-custom-purple text-white font-medium">Ad</p>
                            <p class="font-medium">Revolut</p>
                        </div>
                        <p class="text-xs">Téléchargez Revolut et profitez mieux de votre argent chaque jour</p>
                    </div>
                </div>
                <div class="bg-custom-purple w-10 rounded-r-3xl h-full flex items-center justify-center p-2">
