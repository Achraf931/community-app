...
<template>
    ...
    <section id="content" class="flex flex-col flex-1 overflow-hidden gap-5 p-5">
            ...
            <div class="flex gap-2 items-center w-full">
                <div class="w-full">
                    <div class="flex items-center justify-between">
                        ...
                        <small class="text-light-gray font-medium">201 réponses</small>
                    </div>
            ...
            <div class="flex gap-2 items-center w-full">
                <div class="w-full">
                    <div class="flex items-center justify-between">
                        ...
                        <small class="text-light-gray font-medium">4 réponses</small>
                    </div>
        ...
        <div class="absolute bottom-0 left-0 bg-gradient-to-t from-custom-light-gray h-72 w-full"></div>
    </section>
</template>
